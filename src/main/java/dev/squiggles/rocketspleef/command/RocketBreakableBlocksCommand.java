package dev.squiggles.rocketspleef.command;
...
public class RocketBreakableBlocksCommand {
                ...
                .then(CommandManager.literal("ignitesTNT")
                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                .executes(context -> {
                                    ...
                                    context.getSource().sendFeedback(() -> Text.literal("RocketsIgniteTNT set to: " + value), false);
                                    return 1;
                                })
                        )
                        .executes(context -> {
                            String value = ignitesTNT ? "Rockets currently DO ignite TNT." : "Rockets currently DON'T ignite TNT.";
