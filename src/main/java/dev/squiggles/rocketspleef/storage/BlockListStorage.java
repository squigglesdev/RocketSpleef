package dev.squiggles.rocketspleef.storage;
...
public class BlockListStorage {
    ...
    private static final String BREAKABLE_FILE_NAME = "config/rocketspleef/breakable_blocks.json";
    private static final String IGNITES_FILE_NAME = "config/rocketspleef/ignites_tnt.json";
